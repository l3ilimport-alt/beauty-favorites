...
const POLICIES={
 ...
 terms:`<h2>תקנון האתר</h2>${PNOTE}
  ...
  <h3>הגנת הפרטיות</h3><p>העסק שומר על פרטיות לקוחותיו. פרטי הלקוח נאספים לצורך ביצוע ההזמנה ואספקתה בלבד, אינם נמכרים, ונמסרים לחברת השליחויות ולספק הסליקה אך ורק לצורך השלמת ההזמנה (ראו מדיניות פרטיות מלאה).</p>
